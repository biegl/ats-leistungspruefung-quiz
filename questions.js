...
// The correct answers are taken from the official directive, mostly verbatim.
// Exceptions: for the yes/no questions 20, 24 and 29 the directive only says "No.",
// the reasoning behind it was added so the question isn't trivial to guess.
// Question 16 has been tightened without losing technical content (the CO reference
// and both vol.-% values are preserved).
...
export const QUESTIONS = [
  {
    question: "Woraus setzt sich atembare Luft zusammen?",
    answers: [
  ...
  {
    question: "Wie kann eine Atemkrise entstehen?",
    answers: [
  ...
  {
    question: "Wie lange kann ein Mensch ohne Sauerstoff leben, ohne Schäden davonzutragen?",
    answers: ["Etwa 30 Sekunden", "Etwa 3 Minuten", "Etwa 10 Minuten"],
    correct: 1,
  },
  {
  ...
  {
    question: "Welches Atemgift wirkt auf die äußere Atmung?",
    answers: ["Kohlenstoffmonoxid (CO)", "Kohlenstoffdioxid (CO₂)", "Blausäure (HCN)"],
    correct: 1,
  },
  {
    question: "Was ist Kohlenmonoxid für ein Atemgift, und wie wirkt es?",
    answers: [
  ...
  {
    question: "Wie kann man Sauerstoffmangel erkennen?",
    answers: [
  ...
  {
    question: "Woran erkennt man eine günstige Atemtechnik?",
    answers: [
  ...
  {
    question: "Welche Folgen ergeben sich aus der Störung der Atmung?",
    answers: ["Lebensgefahr", "Nur harmlose Kopfschmerzen", "Nur kurzzeitig verminderte Leistung"],
    correct: 0,
  },
  {
  ...
  {
    question: "Können feste Stoffe Atemgifte sein?",
    answers: [
  ...
  {
    question: "Wann muss man Atemschutzmasken reinigen und überprüfen?",
    answers: [
  ...
  {
    question: "Wo darf man Filtergeräte nicht verwenden?",
    answers: [
  ...
  {
    question: "Welche Kurzprüfungen müssen nach einem Flaschenwechsel durchgeführt werden?",
    answers: [
  ...
  {
    question: "Wie viel Druckabfall darf bei der Hochdruckdichtprüfung innerhalb einer Minute sein?",
    answers: ["Höchstens 20 bar", "Höchstens 10 bar", "Kein Abfall zulässig"],
    correct: 1,
  },
  {
    question: "Wie viel Mindestdruck müssen Pressluftatmer haben, um einsatzbereit zu sein?",
    answers: [
  ...
  {
    question: "Dürfen Atemluftflaschen vollkommen entleert werden?",
    answers: [
  ...
  {
    question: "Wie erfolgt die Berechnung des Rückzugzeitpunktes mittels Manometer?",
    answers: [
  ...
  {
    question: "Welchen Zweck erfüllen Fluchthauben?",
    answers: [
  ...
  {
    question: "In welchen Zeitabständen müssen Atemschutzgeräte grundüberholt werden?",
    answers: [
  ...
  {
    question: "Worin besteht der Unterschied zwischen Normal- und Überdruckgeräten?",
    answers: [
  ...
  {
    question: "Schützt ein Atemfilter gegen höhere Konzentrationen von Atemgiften?",
    answers: ["Ja, mit Kombinationsfilter", "Grundsätzlich nein", "Ja, bei kurzer Einsatzdauer"],
    correct: 1,
  },
  {
  ...
  {
    question: "Wogegen schützt die Fluchthaube?",
    answers: [
